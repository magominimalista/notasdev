...
- Esse é um dos melhores markdown que existe para se trabalhar com testos. Se você copia o conteúdo de um site, ele faz a leitura dos itens (imagens, códigos).
